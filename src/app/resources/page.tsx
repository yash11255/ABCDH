...
import { BookOpen, FileText, Calculator, Users, ChevronRight } from 'lucide-react';
            ...
            <aside className="md:w-1/4 hidden md:block">
              <div className="sticky top-24">
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="#calculators" className="text-blue-700 hover:underline text-sm font-medium block py-1">Clinical Calculators & Assessments</a></li>
            ...
            <main className="md:w-3/4 space-y-16">
              ...
              <div id="tools" className="scroll-mt-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {resources.map((resource, idx) => {
                    ...
                    return (
                      <article key={idx} className="border border-slate-200 rounded-sm p-5">
              ...
              <div id="guidelines" className="scroll-mt-24">
                ...
                <div className="border border-slate-200 rounded-sm overflow-hidden">
                  <div className="guideline-grid hidden bg-slate-100 border-b border-slate-200 p-4 font-bold text-slate-900 text-sm uppercase tracking-wider md:grid">
                    <div>Org / Year</div>
                    <div>Guideline</div>
                  </div>
                  <div className="divide-y divide-slate-200">
                    {guidelines.map((guideline, idx) => (
                      <div key={idx} className="guideline-grid grid items-start gap-4 p-4 transition-colors hover:bg-slate-50 md:gap-6 md:p-5">
                        <div>
              ...
              <div id="calculators" className="scroll-mt-24">
                <h2 className="text-3xl font-serif text-slate-900 mb-6 pb-2 border-b border-slate-200">
                  Clinical Calculators & Assessments
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {calculators.map((calculator, idx) => (
                    <div key={idx} className="border border-slate-200 bg-slate-50 rounded-sm p-5 flex flex-col">
                      ...
                      <p className="text-sm text-slate-700">{calculator.description}</p>
                    </div>
                  ))}
                </div>
              </div>
